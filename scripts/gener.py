from tr_bd.models import Tag, User, Question, Answer, LikeToQuestion, LikeToAnswer
import random
...
def generate_questions(n):
	arr = open('/home/comp/tra/trash/scripts/text.txt', 'r').read().split(' ')
	asize = len(arr)
	print(asize)
...
def generate_tags(n):
	#print('aaa')
	arr = open('/home/comp/tra/trash/scripts/tags', 'r').read().split(' ')
	asize = len(arr)#.size()
...
def run():
	try:
		...
		#generate_answers(150)
		#generate_answer_likes(250)
		generate_question_likes(250)
